...
if ($cantidad<$vendidos) {
    echo "<script> alert('Error la cantidad de productos disponibles no puede ser menor a la cantidad de productos vendidos'); </script>";
    include("../../conexion/db.php");
...
<?php
      ...
      $b = $vendidos;
      $multi = $a * $b;
      $sql="UPDATE añadir SET  img='$img',material='$material',descripcion='$descripcion', cantidad='$cantidad',precio='$precio',vendidos='$vendidos', precioT='$multi'   WHERE id= '$id'";
        $query=mysqli_query($conexion,$sql);
