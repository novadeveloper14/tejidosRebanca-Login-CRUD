...
<html lang="en">
    ...
    <body>
        <header>
            ...
            <div id="botones">
                <a href="nuevo-empleado/index.php">Añadir</a>
                <a href="../reportes/index.php">Reportes</a>
            </div>
            <div class="cerrar perfil">
                    <a href="">
                        <img src="ima/<?php echo $row['fotoPerfil']?>">
